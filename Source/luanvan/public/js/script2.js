function deleteRow5(row)
            ...
            function insRow3()
            {
                ...
                new_row2.cells[2].innerHTML = "<input class='form-control' data-provide='datepicker' name='ntnamsinh" + len2 + "' type='text'>";
            ...
            function insRow6()
            {
                ...
                new_row2.cells[1].innerHTML = "<input class='form-control' data-provide='datepicker' name='ngayhh" + len2 + "' type='text'>";
