            ...
            <ul>
                <li class='active has-sub'><a href=''>Hồ sơ Đảng viên</a>
                    <ul>
                        ...
                        <li><a href='{{URL::to('/')}}/cap-nhat-chuc-vu'>Cập nhật chức vụ và Lí lịch trích ngang</a>
                        </li>
                    </ul>
                </li>
                <li class='active has-sub'><a href='#'>Công văn</a>
                    <ul>
                        <li>
                            <a href='{{URL::to('/')}}/trang-so-cong-van-den'>Công văn đến</a>
                        </li>
                        <li><a href='{{URL::to('/')}}/trang-so-cong-van-di''>Công văn đi</a>
                        </li>
                    </ul>
                </li>
