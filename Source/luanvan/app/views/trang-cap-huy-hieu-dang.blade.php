...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Trang lập danh sách đề nghị cấp huy hiệu Đảng</title>
    ...
    <body>
        ...
        <div>
            <div class="form-inline col-md-9 container alert alert-success">
                <center><h2>Trang lập danh sách đề nghị cấp huy hiệu Đảng</h2></center><br><br>
                <form method="post" action="in-danh-sach-cap-the-huy-hieu-dang">
