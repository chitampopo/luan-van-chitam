...
<html>
    ...
    <body>
        ...
        <div class="form-group col-md-9 container alert alert-info" style=" background-color: #F7FAFF; color: black">
            <center><h2>Trang cập nhật danh mục trình độ chính trị</h2><center><br>
                    <div style="text-align: right" class="col-lg-12">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Thêm trình độ chính trị</button>
                    </div>
                    <br><br>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h3 class="modal-title custom_align" id="Heading" style="color: #228B22">Thêm trình độ chính trị</h3>
                                </div>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <table class="table table-bordered table-striped col-md-8" id="example1">
                                ...
                                <tr>
                                    <td data-field="id">{{ $item->MATRINHDOCT }}</td> 
                                    <td data-field="id">{{ $item->TENTRINHDOCT }}</td> 
                                </tr>
                                @endforeach
                            </table>
                        </div>
