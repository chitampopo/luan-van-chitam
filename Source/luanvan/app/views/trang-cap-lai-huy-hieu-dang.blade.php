...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Trang lập danh sách đề nghị cấp lại huy hiệu Đảng</title>
    ...
    <body>
        ...
        <div>
            <div class="form-inline col-md-9 container alert alert-success">
                <center><h2>Trang lập danh sách đề nghị cấp lại huy hiệu Đảng</h2></center><br><br>
                <form method="post" action="filter-trang-cap-lai-huy-hieu-dang">
                    Loại Huy hiệu: 
                    <select class="form-control" name="maLoaiHuyHieu">
                        <option value="1">30 năm tuổi Đảng</option>
                        <option value="2">40 năm tuổi Đảng</option>
                        <option value="3">50 năm tuổi Đảng</option>
                    </select>
                    <input type="submit" value="Liệt kê" class="form-control">
                </form>
                    <br><br>
                <form method="post" action="in-danh-sach-cap-lai-the-huy-hieu-dang">
                    <input type="hidden" name="maChiBo" value="{{Session::get("maChiBoTaiKhoan")}}">
                    <input type="hidden" name="maLoaiHuyHieu" value="{{$maLoaiHH}}">
                    Đợt ngày:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
