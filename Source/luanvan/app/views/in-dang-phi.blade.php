    ...
    <body>
        <div class="col-md-12">
            ...
            <table class="tb">
                ...
                <tr>
                    <td>{{$thangNam}}</td>
                    <td>{{number_format(0.01*$tongLuong + $tongTruyThu, 0) }} VNĐ</td>
                    <td>{{number_format(0.01*0.3*$tongLuong + $tongTruyThu, 0) }} VNĐ</td>
                    <td>{{number_format(0.01*0.3*0.7*$tongLuong + $tongTruyThu, 0) }} VNĐ</td>
                    <td>{{number_format(0.01*0.3*0.3*$tongLuong + $tongTruyThu, 0) }} VNĐ</td>
                    <td>{{number_format(0.7*(0.01*$tongLuong + $tongTruyThu), 0) }} VNĐ</td>
                </tr>
            </table>
        </div>
    </body>
