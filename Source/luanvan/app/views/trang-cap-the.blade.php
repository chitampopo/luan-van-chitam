    ...
    <body>
        ...
        <div >
            <div class="form-inline col-md-9 container alert alert-info">
                <center><h2>Trang lập danh sách đề nghị cấp thẻ Đảng viên</h2></center><br>
                <form method="post" action="loc-danh-sach-cap-the-moi">
                    <input type="hidden" name="maChiBo" value="{{Session::get("maChiBoTaiKhoan")}}">
                    <label>Đợt ngày:</label><br>
                    <input class="form-control" size="20" data-provide="datepicker" name="dotNgay" type="text" value="{{$dotNgay}}" required>
                    <input type="submit" value="Xem danh sách" class="form-control"><br>
                </form>
                <form method="post" action="in-danh-sach-cap-the-moi">
                    <input type="hidden" name="maChiBo" value="{{Session::get("maChiBoTaiKhoan")}}">
                    <input name="dotNgay" type="hidden" value="{{$dotNgay or null}}">
                    <label>Nơi nhận: </label>
                    <textarea class="form-control" name="noiNhan" id="elm2"></textarea><br>
                    
                    <input type="submit" value="In danh sách" class="form-control"><br><br>
                    <div class="box">
                        <div class="box-body">
