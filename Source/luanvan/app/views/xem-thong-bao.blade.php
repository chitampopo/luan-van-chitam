        ...
        <body style="background-color: dimgray">
                ...
                <div class="col-md-11" style="background-color: white; margin-left: 25px; margin-right: 20px">
                    ...
                    <div class="col-lg-7 alert alert-info" style="margin-left: 50px; margin-right: 0px; margin-top: 10px">
                        ...
                        ?>
                        <u>Đăng bởi {{$chiBo->TENCB}} vào {{date("d-m-Y",strtotime($thongBao->NGAY))}}</u><br>
                        <center><h3>{{$thongBao->TENTB}}</h3></center>
                        <h5>
                            {{$thongBao->NOIDUNG}}
                        </h5>
                        <hr>
                        ...
                        ?>
                        @foreach( $listTinKhac as $tin)
                        <a href="{{URL::to("/")."/xem-thong-bao/".$tin->STTTB}}">{{">> ".$tin->TENTB}}</a><br>
                        @endforeach
                    </div>
                </div>
