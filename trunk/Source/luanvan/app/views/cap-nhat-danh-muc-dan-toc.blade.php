...
<html>
    ...
    <body>
        ...
        <div class="form-group col-md-9 container alert alert-info" style="background-color: #F7FAFF; color: black">
            <center><h2>Trang cập nhật danh mục dân tộc</h2></center>
            <div style="text-align: right" class="col-lg-12">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Thêm dân tộc</button>
            </div>
            <br><br>
            <div class="box">
                <div class="box-body">
                    <table class="table table-bordered table-striped col-md-8" id="example1">
                        <thead>
                            <tr>
                                <th data-field="id" class="col-md-2">Mã dân tộc</th> 
                                <th data-field="id">Tên dân tộc</th> 
                            </tr>
                        </thead>
                        @foreach ($list as $item)
                        <tr>
                            <td data-field="id">{{ $item->MADT }}</td> 
                            <td data-field="id">{{ $item->TENDT }}</td> 
                        </tr>
                        @endforeach
                    </table>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title custom_align" id="Heading" style="color: #228B22">Thêm dân tộc</h3>
                        </div>
