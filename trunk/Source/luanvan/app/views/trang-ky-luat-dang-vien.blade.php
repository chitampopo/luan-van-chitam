                            ...
                            <table class="table table-bordered table-striped" id="example1" data-height="299">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="{{"hinhThucKL".$dangVien->MADANGVIEN}}" class="form-control">
                                                <option value="0">Không</option>
                                                @foreach($listHTKL as $htkl)
                                                <option value="{{$htkl->MAHTKL}}"
                                                <?php
                                        ...
                                        <td>
                                            <input type="text" name="{{"lyDo".$dangVien->MADANGVIEN}}" class="form-control"
                                            <?php
                                            foreach ($listKyLuat as $kyLuat) {
