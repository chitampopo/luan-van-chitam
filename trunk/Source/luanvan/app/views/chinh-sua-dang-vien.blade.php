    ...
    <body>
        ...
        <div class="col-md-9 container">
            ...
            <div class="col-md-12 session" id="box">
                ...
                <input id="ktkhenthuong" value="<?php for( $i = 1 ; $i <= $danhSachKhenThuong ; $i++) { echo "+".$i ;} ?>" type="hidden" name="ktkhenthuong">
                ...
                <input id="ktkyluat" value="<?php for( $i = 1 ; $i <= $danhSachKyLuat ; $i++) { echo "+".$i ;} ?>" type="hidden" name="ktkyluat">
                ...
                <input id="kthuyhieu" value="<?php for( $i = 1 ; $i <= $danhSachHuyHieu ; $i++) { echo "+".$i ;} ?>" type="hidden" name="kthuyhieu">
                ...
                <input id="ktngoaingu" value="<?php for( $i = 1 ; $i <= $danhSachKTNgoaiNgu ; $i++) { echo "+".$i ;} ?>" type="hidden" name="ktngoaingu">
                ...
                <input id="ktcongtac" value="<?php for( $i = 1 ; $i <= $danhSachCongTac ; $i++) { echo "+".$i ;} ?>" type="hidden" name="ktcongtac">
                ...
                <input id="ktdaotao" value="<?php for( $i = 1 ; $i <= $danhSachDaoTao ; $i++) { echo "+".$i ;} ?>" type="hidden" name="ktdaotao">
                ...
                <input id="ktnuocngoai" value="<?php for( $i = 1 ; $i <= $danhSachNuocNgoai ; $i++) { echo "+".$i ;} ?>" type="hidden" name="ktnuocngoai">
                ...
                <input id="ktnguoithan" value="<?php for( $i = 1 ; $i <= $danhSachKTNguoiThan ; $i++) { echo "+".$i ;} ?>" type="hidden" name="ktnguoithan">
                <div class="nguoithan">
